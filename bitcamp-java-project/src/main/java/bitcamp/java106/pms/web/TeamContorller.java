...
public class TeamContorller {
    ...
    public TeamContorller(TeamDao teamDao, TeamMemberDao teamMemberDao, TaskDao taskDao) {
...
//        model.addAttribute("프로퍼티명", "값");
    ...
    public String delete(@RequestParam("name") String name, Map<String,Object> map) throws Exception {
        ...
        map.put("viewUrl", "redirect:list.do");
        return "redirect:list.do";
