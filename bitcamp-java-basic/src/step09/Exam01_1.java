...
public class Exam01_1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 다른 생성자를 사용하여 스트링 인스ㅓㄴ스를 초기화 시키기
        ...
        // 이 생성자는 바이트 배열에 들어있는 값이 ISO-8859-1 이라고 간주하기 때문이다.
        
        // 해결책?
        // String 클래스의 생성자중에서 바이트 배열과 인코딩 정보를 함께 받는 생성자를 호출하라!
        // => 즉 bytes 배열에 EUC-KR의 코드 값이 들어있다고 알려준다.
