...
public class Exam01_6 {
    ...
    static class Member {
        ...
        // -> 모든 인스턴스가 가음의 변수에 대해 같은 값을 가질 경우
        // 클래스 변수로 만드는 것이 바람직하다.
        // -> 만약 값을 저장하는 것이 아닌 조회하는 용도로만 사용하는 변수라면
        // 대문자로 선언하여 상수임을 표현하라!
        // -> 조회용도로만 사용하기로 했으면 문법적으로 값을 변경하는 것을 막아라!
    ...
    public static void main(String[] args) {
        ...
        // 소스코드를 작성한 사람도 숫자의 의미를 기억하기가 쉽지 않은데,
        // 남의 소스 코드를 유지보수하는 사람은 더더욱 숫자의 의미를 파악하기가 쉽지않다.
        // 주석이나 개발문서를 자세히 살펴보지 않는 이상에는 숫자의 의미를 파악하기 쉽지 않다.
        //
