...
public class Exam02_1 {
    // 문법
    // [리턴값의 타입] 함수명(파라미터 선언,...) {명령어들}
    // - 리턴값의 타입?
    //  -> 함수 불록에 들어있는 명령어를 수행완료한 후 그 결과로 놓이는 값의 타입.
    // - 파라미터 선언?
    ...
    public static void main(String[] args) {
        ...
        //     즉 파라미터 변수에 넘겨주는 값
        //     파라미터 변수의 개수와 타입과 개수와 순서에 맞게 값을 넘겨줘야한다.
        //     만약 변수의 타입과 값의 타입이 다르면 컴파일 오류!
        //     만약 변수의 개수와 값의 개수가 다르면 컴파일 오류!
        //     변수 선언 순서와 값의순서가 다르면 컴파일 오류!
        //
        // - 리턴값을 반을 변수
        //   -> 메서드 블록을 실행한 후 리턴도는 값을 받을 변수이다.
        //   -> 메서드가 값을 리턴한다 하더라도 값을 받기 싫으면 
        //      변수를 선언하지 않아도 된다.
        //   -> 값을 리턴하지 않는 메서드에 대해 변수를 서넌하면 컴파일 오류!
        ...
        hello();
        // hello {}의 명령을 실행한 후 다시 원래의 위치로 돌아와서
        // 다음 명령을 실행한다.

        System.out.println("hello() 실행완료!");
        
        // hello 메서드는 파라미터 변수가 없기 떄문에 호출할 떄 값을 넣


        // hello(100); // 컴파일 오류!
        
        // hello 메서드는 값을 리턴하지 않기 떄문에 변수에 값을 넣으려 하면
        // int i;
        // i = hello() // 컴파일 오류!
...
// 매서드 = 함수?
// 명령어를 기능 단위로 관리하기 쉽게 별도로 문리하여 묶어놓은 것
// 반복적으로 자주 사용하는 명령어를 재사용 할 수 있도록 별도로 분리하여 묶어놓은 것
//
//메서드 종류?
// - 클래스 메서드
//   -> 클래스에 소속되어 있따.
