...
update test1 set pstno='111', fax='2222' where no = 3;
update test1 set tel='3030', fax='112' where no = 2;
...
insert into test1(name, tel) values ('xxx', '111');
insert into test1(name, tel) values ('yyy', '222');
insert into test1(name, tel) values ('zzz', '333');
